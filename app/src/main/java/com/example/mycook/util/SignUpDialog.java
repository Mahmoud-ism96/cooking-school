...
public class SignUpDialog {
    public static void showSignupDialog(Activity activity) {
        new MaterialAlertDialogBuilder(activity).setTitle(R.string.dialog_signup_title).setMessage(R.string.dialog_signup_body).setNegativeButton(activity.getResources().getString(R.string.dialog_signup_btn_negative), (dialog, which) -> {
