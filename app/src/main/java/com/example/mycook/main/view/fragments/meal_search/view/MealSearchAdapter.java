...
class MealSearchAdapter extends RecyclerView.Adapter<MealSearchAdapter.ViewHolder> {
    ...
    public MealSearchAdapter(Context context, List<Meal> meals, OnDailyMealClickListener listener) {
